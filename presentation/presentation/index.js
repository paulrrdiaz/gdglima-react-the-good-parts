    ...
    return (
      <Deck transition={["zoom", "slide"]} transitionDuration={500} theme={theme}>
        <Slide transition={["zoom"]} bgColor="blue">
          ...
          <Heading size={1} fit caps lineHeight={1} textColor="white">React - The Good Parts</Heading>
        </Slide>
        <Slide transition={["zoom"]} bgColor="blue">
        ...
        <Slide transition={["fade"]} bgColor="blue">
          ...
          <Link margin="10px 0 0" size={6} textColor="white" href="https://www.facebook.com/groups/frontendpe/" target="_blank">Click me -please-</Link>
        </Slide>
        <Slide transition={["fade"]} bgColor="blue">
        ...
        <Slide transition={["fade"]} bgColor="skyblue">
          ...
          <Link margin="10px 0 0" size={6} textColor="white" href="https://github.com/storybooks/storybook" target="_blank">Click me -please-</Link>
        </Slide>
        <Slide transition={["fade"]} bgColor="skyblue">
        ...
        <Slide transition={["fade"]} bgColor="skyblue">
          <Heading size={3} textColor="white">Thank you!</Heading>
          <Text size={6} textColor="blue">if you can share this, it'd be awesome :)</Text>
        </Slide>
      </Deck>
    );
  }
